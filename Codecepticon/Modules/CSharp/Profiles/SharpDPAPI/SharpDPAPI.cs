...
using Codecepticon.Modules.CSharp.Profiles.SharpDPAPI.Rewriters;
...
namespace Codecepticon.Modules.CSharp.Profiles.SharpDPAPI
{
    class SharpDPAPI : BaseProfile
    {
        ...
        public override async Task<Solution> Before(Solution solution, Project project)
        {
            ...
            {
                Logger.Debug("SharpDPAPI: Rewriting command line");
                solution = await RewriteCommandLine(solution, project);
            }

            Logger.Debug("SharpDPAPI: Removing help text");
        ...
        public override async Task<Solution> After(Solution solution, Project project)
        {
            ...
            {
                Logger.Debug("SharpDPAPI: Renaming RootNamespace");
